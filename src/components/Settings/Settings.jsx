                            ...
                            {PhotoSettings.map((data1, index1) => {
                              return (
                                <div
                                  key={index1}
                                  className={
                                    imageType.value === data1.value
                                      ? "sub-menu-items cursor-pointer sub-menu-items-active"
                                      : "sub-menu-items cursor-pointer"
                                  }
                                  onClick={() =>
                                    handleSetImageType({
                                      label: data1.label,
                          ...
                          <div>
                            {ImageTiming.map((data2, index2) => {
                              return (
                                <div
                                  key={index2}
                                  className="sub-menu-items cursor-pointer"
                                >
                                  {data2.label}
                                </div>
                              );
